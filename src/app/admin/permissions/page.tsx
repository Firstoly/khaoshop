...
import { ShieldCheck, UtensilsCrossed, ClipboardList, AlertCircle, BarChart2, Settings } from 'lucide-react'
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 text-xs text-gray-500">
              <tr>
                <th className="text-left px-6 py-3 font-semibold">ร้าน / เจ้าของ</th>
                {PERM_DEFS.map(p => (
